...
<section class="gallery">
        <div class="container">
            ...
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/galerie1botez.jpg" class="img-fluid pb-3">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/galerie2botez.jpg" class="img-fluid pb-3">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/galerie3botez.jpg" class="img-fluid pb-3">
            </div>
        </div>
        </div>
</section>
