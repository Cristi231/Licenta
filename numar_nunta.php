...
if ($_SESSION['user_name'] == 'admin') {
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            echo "Rezervare : " . $row["event_name"]. " - " . $row["event_start_date"]. " - " . $row["event_end_date"]." - " .$row["event_start_time"]." - " .$row["event_end_time"]." - " . $row["event_hall"]." - " . $row["event_number"]."- " . $row["event_type"]."- " . $row["event_description"]."<br>";
        }
    } else {
