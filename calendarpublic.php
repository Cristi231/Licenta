                    ...
                    if ($result) {
                        ...
                        echo '<thead>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo '<tbody>
                                        <tr>
                                            <td><a href="detalii_eveniment.php?event_id=' . $row['event_id'] . '">' . $row['event_name'] . '</a></td>
	...
	var calendar = $('#calendar').fullCalendar({
	    ...
	    eventRender: function(event, element, view) { 
            element.bind('click', function() {
                swal("Pentru evenimente private nu sunt detalii.\nPentru evenimentele publice, accesati sectiunea de cautare si apasati pe titlul evenimentului dorit");
				});
    	}
