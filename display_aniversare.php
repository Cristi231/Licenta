...
$display_query = "select event_id,event_name,event_start_date,event_end_date,event_hall,event_number from calendar_aniversare_master";             
...
if($count>0) 
{
	...
	$data_arr[$i]['title'] = $data_row['event_hall'];
