...
<section class="information">
    ...
    <section class="gallery">
        <div class="container">
            ...
            <img src="images/meniu3nunta.jpg" class="img-fluid pb-3">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/meniu3nunta2.jpg" class="img-fluid pb-3">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/meniu3nunta3.jpg" class="img-fluid pb-3">
            </div>
        </div>
        </div>
    </section>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function saveChanges(content) {
            ...
            xhr.open("POST", "save_meniu3nunta.php", true);
