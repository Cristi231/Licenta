  ...
  <a class="nav-link" href="calendarnunta.php">Rezervari</a>
    ...
    <section class="gallery">
        <div class="container">
            ...
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/galerie1nunta.jpg" class="img-fluid pb-3">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/galerie2nunta.jpg" class="img-fluid pb-3">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/galerie3nunta.jpg" class="img-fluid pb-3">
            </div>
        </div>
        </div>
    </section>
