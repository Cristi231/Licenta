...
<nav class="nav flex-column">
  ...
  <a class="nav-link" href="calendarnunta.php">Rezervari</a>
    ...
    <div class="container">
        <h2 class="text-center">Informatii despre Nunta</h2>
<?php if ($is_admin): ?>
            <a href="numar_nunta.php" style ="outline: none; border:none" class="btn btn-sm btn-primary" style="max-width: 100px;">Detalii confirmari</a>
        <?php endif; ?>
