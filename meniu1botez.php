...
<section class="information">
    <div class="container">
        ...
        <div id="editContent" contenteditable="false">
            <?php
            $config_content = file_get_contents('meniu1botez.txt');
            echo $config_content;
            ?>
        </div>
    </div>
    <section class="gallery">
        <div class="container">
            ...
            <img src="images/meniu1botez.jpg" class="img-fluid pb-3">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/meniu1botez2.jpg" class="img-fluid pb-3">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
            <img src="images/meniu1botez3.jpg" class="img-fluid pb-3">
            </div>
        </div>
        </div>
    </section>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function saveChanges(content) {
            ...
            xhr.open("POST", "save_meniu1botez.php", true);
